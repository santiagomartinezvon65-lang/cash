...
# Título
st.markdown("""
<h1 style='text-align: center; font-size: 2.5rem; font-weight: bold; margin-bottom: 1rem;'>
Currency Converter
</h1>
...
# Función para obtener tasa de cambio de manera segura
...
if rate is not None:
    ...
    # Resultado principal con estilo
    st.markdown(f"""
    <div style='
    ...
    # Tabla de referencia con estilo
